            ...
            <form action="{{URL::to($urls)}}" method="post">
                <div class="col-md-12">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label for="lbsmot">Sudah Menyala</label></div>
                            <div class="col-sm-2">
                                <label>
                                    @if($row->sudah_nyala =='1') <input name="sudah_nyala" type="checkbox" checked=checked>
                                    @else <input name="sudah_nyala" type="checkbox" >
                                    @endif
                                </label>
                            </div>
                        </div>
